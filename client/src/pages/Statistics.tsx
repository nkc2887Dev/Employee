...
const Statistics: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">Department-wise Highest Salary</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {stats?.departmentHighestSalary.map(
                (item: { department: string; salary: number }, index: number) => (
                  <tr key={index}>
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">Salary Range-wise Employee Count</h2>
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
      ...
      <div>
        <h2 className="text-xl font-bold mb-4">Youngest Employee by Department</h2>
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {stats?.youngestByDepartment.map(
                (item: { department: string; name: string; age: number }, index: number) => (
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                      {index + 1}
                    </td>
