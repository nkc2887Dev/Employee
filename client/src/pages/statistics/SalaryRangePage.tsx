...
import SalaryRangeStats from './SalaryRangeStats';
import { ErrorIcon } from '../../icons';

const SalaryRangePage: React.FC = () => {
  const {
    data: stats,
    isLoading,
    error,
  ...
  return (
    <PageContainer title="Salary Range-wise Employee Count">
      <SalaryRangeStats data={stats?.salaryRangeCount || []} />
    </PageContainer>
  );
};
